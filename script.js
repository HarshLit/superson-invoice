class InvoiceGenerator {
    ...
    generatePDF() {
        ...
        // Totals table - connected directly to items table (compact)
        const totalsStartY = itemsEndY + 5; // Start right after items
        const totalWidth = 75;
        const totalX = 115; // Align with right side of items table
